  ...
  return (
    <div>
      ...
      >
        <div className="hover:text-black ">
          <div
            className={`w-80 mt-4 xl:mb-10 lg:mb-5 md:mb-2 sm:mb-10 border-black border-4 pt-5 duration-300 text-white rounded-3xl ${color}`}
          >
            <div className="flex justify-center mt-5">
            <div className="text-4xl">{topic}</div>
            </div>
            ...
            <div className="pl-8 pb-10 pr-4 text-2xl text-gray-900">{subTopic}</div>
          </div>
        </div>
      </div>
    </div>
